import { useCreateTodoItemFormValues, type CreateTodoItemFormValues } from '../../lib';
...
export default function CreateTodoItemForm({
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div>
        <input {...register('title', { onChange: onValuesChange })} type="text" placeholder="제목" />
        <textarea {...register('content', { onChange: onValuesChange })} placeholder="내용" />
